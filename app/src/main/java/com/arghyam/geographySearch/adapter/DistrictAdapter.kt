...
class DistrictAdapter(val DistrictList : ArrayList<DistrictModel>, context: Context, val geographyInterface: GeographyInterface):RecyclerView.Adapter<DistrictAdapter.DistrictViewHolder>(){
