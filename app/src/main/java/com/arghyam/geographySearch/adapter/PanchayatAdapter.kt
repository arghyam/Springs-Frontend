...
class PanchyatAdapter(val PanchayatList : ArrayList<PanchayatModel>, context: Context, val geographyInterface: GeographyInterface):RecyclerView.Adapter<PanchyatAdapter.PanchayatViewHolder>(){
