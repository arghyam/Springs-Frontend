package com.arghyam.admin.repository
...
class GetRegisteredUsersRepository constructor() {

    fun getRegisteredUsersApiRequest(
        context: Context,
        responseListener: ResponseListener<ResponseModel>
    ) {
        val getUsersCall = RestClient.getWebServiceData()?.getRegisteredUsers()
        getUsersCall?.enqueue(object : Callback<ResponseModel> {
