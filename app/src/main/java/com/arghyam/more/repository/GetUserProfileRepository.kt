package com.arghyam.more.repository
...
class GetUserProfileRepository  @Inject constructor() {

    fun getUserProfileApiRequest(context: Context, requestModel: RequestModel, responseListener: ResponseListener<ResponseModel>) {
        val getUserProfileCall = RestClient.getWebServiceData()?.getUserProfile(requestModel)
